...
public sealed interface Flight {
    ...
    Cities cities = Cities.read();

    record SimpleFlight(City from, City to) implements Flight {
    ...
    record MultilegFlight(SimpleFlight flight1, SimpleFlight flight2) implements Flight {
